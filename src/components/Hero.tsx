...
const Hero: React.FC = () => {
  ...
  return (
    <section 
      ref={heroRef}
      className="relative min-h-screen w-full flex flex-col overflow-visible bg-design-cream transition-colors duration-500 px-4 sm:px-6 md:px-8"
    >
      ...
      <ParallaxFloat offset={30}>
        <div className="relative z-10 w-full text-center flex flex-col items-center justify-center">
          ...
          <div className="relative w-full">
            ...
            <div className="flex flex-col items-center gap-2 mt-2 md:mt-4 px-2">
             <div className="flex items-center gap-3 sm:gap-6">
                <div className="h-[1px] w-4 sm:w-8 md:w-12 bg-design-black/10 dark:bg-white/10"></div>
                <StaggeredText 
                  text="Precision Meets Performance" 
                  direction="up" 
                  distance={20} 
                  delay={1.4}
