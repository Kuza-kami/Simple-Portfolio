...
const Hero: React.FC = () => {
  return (
    <section 
      className="relative min-h-screen w-full flex flex-col justify-between overflow-hidden bg-transparent transition-colors duration-500 pt-40 md:pt-32 pb-8 md:pb-12 px-4 sm:px-6 md:px-8"
    >
        ...
        <div className="relative z-10 w-full text-center flex flex-col items-center justify-center">
          ...
          <div className="relative w-full">
              <div className="overflow-hidden pb-12 md:pb-16">
                 <h1 className="text-[34vw] md:text-[22vw] font-display font-bold leading-[0.85] md:leading-[0.75] tracking-tighter text-design-black dark:text-design-white flex flex-wrap justify-center select-none px-6 md:px-0 gap-y-2 md:gap-y-0">
              ...
              <div className="absolute bottom-6 md:bottom-8 left-1/2 -translate-x-1/2 z-20">
                   ...
                   >
                     <div className="relative">
                        <span className="relative inline-block text-sm sm:text-lg md:text-3xl font-display font-bold text-design-black uppercase bg-design-blue px-3 py-1 sm:px-4 sm:py-1.5 md:px-6 md:py-2 border-2 border-design-black dark:border-white shadow-flat dark:shadow-flat-white whitespace-nowrap">
                           Amy Simpson
                        </span>
                     </div>
                   </motion.div>
          ...
          <motion.div 
            ...
            className="flex flex-col items-center gap-6 mt-6 md:mt-12 px-2"
          >
